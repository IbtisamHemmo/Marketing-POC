...
export default async function HomePage() {
  ...
  const { hero, about, features, testimonials, banner, contact, siteSettings } = data
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {banner && banner.isVisible && (banner.title || banner.images?.length > 0) && (
          ...
          {banner.bannerType === 'carousel' && banner.images?.length > 0 ? (
            ...
            <div className="py-12 px-4">
              <div className="max-w-4xl mx-auto text-center">
                {banner.title && <h2 className="text-3xl font-bold mb-4">{banner.title}</h2>}
                {banner.description && <p className="text-lg mb-6">{banner.description}</p>}
                {banner.ctaText && banner.ctaLink && (
                  <Link 
                    href={banner.ctaLink}
      ...
      {/* Hero Section */}
      <section className={`${banner && banner.isVisible ? 'pt-8' : 'pt-24'} pb-20 bg-gradient-to-br from-green-50 to-emerald-50`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                {hero?.description || "Discover premium plants, expert care guides, and create your perfect green sanctuary. From indoor gardens to outdoor landscapes."}
              </p>
              ...
              {hero?.heroImage ? (
                ...
                <div className="w-full h-96 bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl shadow-2xl flex items-center justify-center">
                  <svg className="w-24 h-24 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707"></path>
                  </svg>
                </div>
              )}
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="prose prose-lg text-gray-600">
                  {about.description || "At FloraFlow, we believe that every space deserves the beauty and tranquility that plants bring. Our mission is to make plant care accessible, enjoyable, and successful for everyone, whether you're a seasoned gardener or just starting your green journey."}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {features?.subtitle || "Everything you need to create and maintain your perfect plant paradise"}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features?.featuresList?.map((feature, index) => (
            ...
            )) || [
              {
                ...
                description: "Curated collection of healthy, beautiful plants sourced from trusted growers.",
                icon: "🌿"
              },
              {
                title: "Expert Care Guides",
                description: "Detailed care instructions and tips from horticultural experts.",
                icon: "📖"
              },
              {
                title: "Plant Health Monitoring",
                description: "Track your plants' health with our smart monitoring tools.",
                icon: "📊"
              }
            ].map((feature, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
        ...
        <section id="testimonials" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                {testimonials.subtitle || "Join thousands of happy plant parents who trust FloraFlow"}
              </p>
            </div>
        ...
        <section id="contact" className="py-20 bg-green-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                {contact.description || "Have questions about plants or need personalized advice? We're here to help!"}
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6">
                {siteSettings?.footerText || "Transform your space with beautiful, healthy plants. Expert care guides and premium selections for every plant lover."}
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Plant Health</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Troubleshooting</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Seasonal Tips</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-400">
              &copy; 2025 {siteSettings?.siteName || "FloraFlow"}. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
